...
public class BuyTicketWebSmallPaymentActivity extends BaseActivity {
...
//				}
		...
		WebViewClient wc = new WebViewClient() {
			...
			public void onPageFinished(WebView view, String url) {
				...
				if (url.contains("http://wap.szicity.com/cm/powerManager/touchsimple/onepay.jsp")
						|| url.contains("http://wap.szicity.com/cm/powerManager/touchsimple/nomoney.jsp")//小额支付余额不足
						|| url.contains("http://wap.szicity.com/cm/powerManager/touchsimple/xezf.jsp")//小额支付余额可正常支付
				...
				if (url.contains("PresentTicketPayResultServlet?result=0")) {
					if (isDuihuan) {
						...
						Intent in = new Intent(BuyTicketWebSmallPaymentActivity.this, TicketExchangeSuccessAct.class);
						...
						Intent in = new Intent(BuyTicketWebSmallPaymentActivity.this, MovieTicketSuccessAct.class);
	...
	class MyJavaSriptInterface {
		...
		public void showHTML(String html) {
			...
			if (html.contains("resp_code=0000")) {
				if (isDuihuan) {
					System.out.println("duihuan---------------" + targetMobile);
					Intent in = new Intent(BuyTicketWebSmallPaymentActivity.this, TicketExchangeSuccessAct.class);
					in.putExtra("c_name", merchantName);
...
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "外部系统 ID或密码错误", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=1002")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "接入IP非法", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=2003")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "订单已经存在", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=1003")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "请求数据格式异常", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=2001")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "该业务尚未开通", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=2002")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "订单不存在", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=9001")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "未知错误", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=90019")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "响应超时", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=03001")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "必要参数为空", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=03004")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "SPID 密码有问题", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=03003")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "不存在该商家的支付方式", Toast.LENGTH_LONG).show();
//				finish();
				
				
//			} else if (html.contains("resp_code=600221")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "超日消费额", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=600222")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "超月消费额", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=600223")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "超一次消费额", Toast.LENGTH_LONG).show();
//				finish();
//			} else if (html.contains("resp_code=")) {
//				Toast.makeText(BuyTicketWebSmallPaymentActivity.this, "话费支付异常", Toast.LENGTH_LONG).show();
//				finish();
			}
		}
	}
...
//				+ "\"><input type=\"hidden\" name=\"backUrl\" value=\"/http://wap.szicity.com\"><input type=\"hidden\" name=\"uid\" value=\""
				...
				+ token
				+ "\"><input type=\"hidden\" name=\"orderDesc\" value=\"empty\"><input type=\"hidden\" name=\"addr\" value=\"empty\"><input type=\"hidden\" name=\"payType\" value=\"21\"><input type=\"hidden\" name=\"spPay\" value=\"\"><input type=\"hidden\" name=\"period\" value=\"10\"><input type=\"hidden\" name=\"periodUnit\" value=\"4\"><input type=\"hidden\" name=\"outMerchantCode\" value=\"empty\"><input type=\"hidden\" name=\"reqsource\" value=\"1\"></form></body></html>";
	}
