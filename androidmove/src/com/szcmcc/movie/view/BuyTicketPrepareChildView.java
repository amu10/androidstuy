...
public class BuyTicketPrepareChildView extends LinearLayout {
	...
	private CinemaPrepare byseat;
	
	private String m_id;
	
	public BuyTicketPrepareChildView(Context context, LinearLayout linear) {
		super(context);
...
//							"----cinemaRoom----"+byseat.room+"----cinemaTime----"+byseat.s_time);
	...
	public void setData(MovieCinema moviecinema, CinemaPrepare byseat, String m_id) {
		...
		//时间过期
		if(today.equals(((CinemaPrepareAct)context).getCurrentDate()) && PublicUtils.isCompareTime(nowTime, byseat.s_time)) {
