...
public class TouchZoomControlSeat {
...
//			ViewZoomTouch imageView = getCurrentImageView();
	...
	public ViewZoomTouchSeat getZoomView(){
		return zoomView;
	}
