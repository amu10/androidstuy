...
public class ViewZoomTouch extends 
//ViewGroup 
//ImageView
//FrameLayout
LinearLayout
{
	...
	public final float mMaxZoom = 1.8f;
...
//		}
	...
	public ViewZoomTouch(Context context) {
		super(context);
		init();
	}

	public ViewZoomTouch(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
