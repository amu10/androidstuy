...
//        Log.e(TAG,"onScrollChanged:l:"+l+" ,t : "+t+" ,oldl:"+oldl+" ,oldt:"+oldt);
	 private void onSyncScroll(int x, int y){
		 Log.e(TAG,"scrollTo,x:"+x+" ,y: "+y);
        if(mHView!=null){
            mHView.scrollTo(x, getScrollY());
        }
        if(mVView != null){
        	mVView.scrollTo(getScrollX(), y);
        }
        if(mV2View != null){
        	mV2View.scrollTo(getScrollX(), y);
        }
    }

    public void setScrollHView(View view){
        mHView = view;
    }
    public void setScrollVView(View view){
    	mVView = view;
    }
    public void setScrollV2View(View view){
    	mV2View = view;
    }
} 