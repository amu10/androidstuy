...
public class MyProcessbar extends ImageView{
...
//	String pb_str[] = {"","��","����","������"};
	int pb_res[] = null;//{R.drawable.progress1,R.drawable.progress2,R.drawable.progress3,R.drawable.progress4};
	int index;
...
//	@Override
//	protected void onVisibilityChanged(View  C, int v) {
//		 if (getVisibility() != v) {
//	            if (v == GONE || v == INVISIBLE) {
//	            	stopAnimation();
//	            } else if (v == VISIBLE) {
